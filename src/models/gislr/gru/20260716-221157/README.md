# StreamingGRU — FP_118 subset (20260716-221157)
...
- architecture: StreamingGRU (unidirectional/causal GRU, hidden 256 x 2 layers,
  LayerNorm in/out, dropout 0.3) — 930,238 params
- input: FP_118 (118 landmarks) x xyz = 354 features/frame
...
- best val accuracy: **0.7460** (60/60 epochs)
