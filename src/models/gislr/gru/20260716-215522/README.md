# StreamingGRU — ME_132 subset (20260716-215522)
...
- architecture: StreamingGRU (unidirectional/causal GRU, hidden 256 x 2 layers,
  LayerNorm in/out, dropout 0.3) — 962,578 params
- input: ME_132 (132 landmarks) x xyz = 396 features/frame
...
- best val accuracy: **0.7247** (60/60 epochs)
